...
function_names = [ ...
    ...
    "attitude_pid_params"; "attitude_pid_step"; ...
    "cascade_pid_params"; "cascade_pid_step"; ...
    "validate_cascade_pid_timing"; ...
    "attitude_pid_scenarios"; "cascade_pid_scenarios"; ...
    "simulate_open_loop"; "simulate_attitude_pid"; ...
    "simulate_cascade_pid"; "run_simulink_open_loop"; ...
    "run_attitude_pid_simulink"; "run_cascade_pid_simulink"; ...
    "build_twsbr_simulink"; "build_attitude_pid_simulink"; ...
    "build_cascade_pid_simulink"; ...
    "plot_attitude_pid_results"; "plot_cascade_pid_results"; ...
    "run_project_workflow"; "run_attitude_pid_workflow"; ...
    "run_cascade_pid_workflow"];
directory_names = [ ...
    repmat("models", 5, 1); repmat("controllers", 5, 1); ...
    repmat("scenarios", 2, 1); repmat("simulation", 6, 1); ...
    repmat("builders", 3, 1); repmat("visualization", 2, 1); ...
    repmat("workflows", 3, 1)];
end
...
function_names = [ ...
    ...
    "create_cascade_pid_simulink_model"];
