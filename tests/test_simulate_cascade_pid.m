...
function test_unsettled_and_early_failure_metrics_exceed_event_horizons(test_case)
plant_params = twsbr_params();
params = zero_gain_params(plant_params);
...
verifyGreaterThan(test_case, settling_result.metrics.position_settling_time, ...
    0.003);
verifyGreaterThan(test_case, recovery_result.metrics.disturbance_recovery_time, ...
    0.003);
verifyGreaterThan(test_case, failure_result.metrics.position_settling_time, ...
    0.05);
verifyGreaterThan(test_case, ...
    failure_result.metrics.disturbance_recovery_time, 0.02);
...
verifyFalse(test_case, ...
    settling_result.metrics.position_settling_time <= 0.003);
verifyFalse(test_case, ...
    recovery_result.metrics.disturbance_recovery_time <= 0.003);
